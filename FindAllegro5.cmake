...
IF(ALLEGRO5_LIBRARY)
  ...
  SET(ALLEGRO5_INLUDE_DIRS "${ALLEGRO5_INCLUDE_DIR}" CACHE STRING "Allegro5 Include Dirs")
  SET(ALLEGRO5_FOUND TRUE)
  #MESSAGE(STATUS ${ALLEGRO5_LIBRARY})
ENDIF(ALLEGRO5_LIBRARY)

MARK_AS_ADVANCED(ALLEGRO5_INCLUDE_DIR ALLEGRO5_LIBRARIES ALLEGRO5_LIBRARY)
